...
{
    public sealed class SelectedAndAllChildernAggregation<T> : BaseAggregation<T> where T : IMember
    {
        public SelectedAndAllChildernAggregation(List<int> selectedMembers, List<T> members) : base(selectedMembers, members)
        {
        }
        ...
        protected override void PopulateDisplayMembers()
        {
            ...
            DisplayMembers = selectedAndAllChildren.Distinct();
        }
    }
}
